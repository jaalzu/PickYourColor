...
export const Footer = () => {
  const { starMessage, githubBtn, copyright } = useLang({
    es: {
      starMessage:
        "Ya que llegaste hasta acá, podes dejarme una estrellita. Gracias!",
      githubBtn: "Ir a GitHub",
      copyright: "Cualquier parecido con una web real es pura coincidencia.",
    },
    en: {
      starMessage:
        "Since you made it this far, a star would help me a lot. Thanks!",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col items-center md:items-end gap-2 flex-1 order-3">
            <p
              className="text-md text-center md:text-right"
