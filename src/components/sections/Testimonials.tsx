...
export const Testimonials = () => {
  ...
  const { scrollRef, handleMouseEnter, handleMouseLeave, handleMouseDown } = useTestimonialsScroll();
  ...
  return (
    <section className="py-10 md:py-19 w-full overflow-hidden relative">
     <h2
  className="font-mono text-4xl md:text-5xl font-bold text-center mb-12 max-w-xs md:max-w-md lg:max-w-2xl mx-auto"
        ...
        {doubled.map((t, i) => (
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <p className="text-xl leading-[1.3] italic font-medium" style={{ color: 'var(--color-text)' }}>
                "{t.comment}"
              </p>
            </div>
