  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        <h2
          className="font-mono  text-4xl md:text-5xl font-bold text-center mb-7"
...
{/* Descripción */}
<p className="text-xl mb-9" style={{ color: 'var(--color-text)', opacity: 0.8 }}>
  {plan.description}
</p>
    ...
    Get Started
                ...
                <ul className="space-y-4 mb-5">
                  {plan.features.map((feature) => (
                    ...
                    <span className="md:text-md text-lg" style={{ color: 'var(--color-text)' }}>
                        {feature}
                      </span>
                    </li>
                  ))}
