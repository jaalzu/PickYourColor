...
export const Hero = () => {
  ...
  return (
    <section className="min-h-[92vh] lg:min-h-[89vh] flex flex-col relative overflow-visible">
      ...
      <div className="flex-1 flex items-start md:items-center justify-center px-4 pt-8 md:pb-35 relative z-10">
        <div className="max-w-sm md:max-w-2xl lg:max-w-6xl text-center">
          <h1
            className=" text-5xl md:text-5xl lg:text-[77px] leading-[1] font-bold mb-4"
