  ...
  return (
    <div className={`cma-wrap ${className}`}>
      ...
      <svg viewBox="70 50 160 150" className="cma-svg">
        <circle className="cma-circle cma-primary" cx={PRIMARY.cx} cy={PRIMARY.cy} r={PRIMARY.r} />
        <circle className="cma-circle cma-secondary" cx={SECONDARY.cx} cy={SECONDARY.cy} r={SECONDARY.r} />
        <circle className="cma-circle cma-accent" cx={ACCENT.cx} cy={ACCENT.cy} r={ACCENT.r} />
      </svg>
    </div>
  );
};
